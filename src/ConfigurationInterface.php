...
interface ConfigurationInterface extends HttpConfigurations
{
    ...
    /**
     * Get the credentials to use with ApiToken
     */
    public function getApiTokenCredentials(): ApiTokenCredentials;

    /**
     * Get the credentials builder instance to update credentials for ApiToken
     */
    ...
    /**
     * Get the credentials to use with CsrfToken
     */
    public function getCsrfTokenCredentials(): CsrfTokenCredentials;

    /**
     * Get the credentials builder instance to update credentials for CsrfToken
     */
